...
VENUE_ALIASES: dict[tuple[str, Optional[str]], tuple[str, str, str]] = {
    ...
    ('Tribhuvan University International Cricket Ground, Kirtipur', 'Kirtipur'): ('Tribhuvan University International Cricket Ground, Kirtipur', 'Kirtipur', 'Nepal'),
    ('Tribhuvan University International Cricket Ground', 'Kirtipur'): ('Tribhuvan University International Cricket Ground, Kirtipur', 'Kirtipur', 'Nepal'),

    # ─── Edgbaston, Birmingham (Birmingham, England) ─
    ('Edgbaston, Birmingham', 'Birmingham'): ('Edgbaston, Birmingham', 'Birmingham', 'England'),
    ('Edgbaston', 'Birmingham'): ('Edgbaston, Birmingham', 'Birmingham', 'England'),
    ...
    ('Bayuemas Oval, Kuala Lumpur', 'Kuala Lumpur'): ('Bayuemas Oval, Kuala Lumpur', 'Kuala Lumpur', 'Malaysia'),
    ('Bayuemas Oval', 'Kuala Lumpur'): ('Bayuemas Oval, Kuala Lumpur', 'Kuala Lumpur', 'Malaysia'),
    ...
    ('Terdthai Cricket Ground, Bangkok', 'Bangkok'): ('Terdthai Cricket Ground, Bangkok', 'Bangkok', 'Thailand'),
    ('Terdthai Cricket Ground', 'Bangkok'): ('Terdthai Cricket Ground, Bangkok', 'Bangkok', 'Thailand'),
    ...
    ('The Rose Bowl, Southampton', 'Southampton'): ('The Rose Bowl, Southampton', 'Southampton', 'England'),
    ('The Rose Bowl', 'Southampton'): ('The Rose Bowl, Southampton', 'Southampton', 'England'),

    # ─── Kennington Oval, London (London, England) ─
    ('Kennington Oval, London', 'London'): ('Kennington Oval, London', 'London', 'England'),
    ('Kennington Oval', 'London'): ('Kennington Oval, London', 'London', 'England'),
    ...
    ('Gaddafi Stadium, Lahore', 'Lahore'): ('Gaddafi Stadium, Lahore', 'Lahore', 'Pakistan'),
    ('Gaddafi Stadium', 'Lahore'): ('Gaddafi Stadium, Lahore', 'Lahore', 'Pakistan'),
    ...
    ('Eden Gardens', 'Kolkata'): ('Eden Gardens, Kolkata', 'Kolkata', 'India'),
    ('Eden Gardens, Kolkata', 'Kolkata'): ('Eden Gardens, Kolkata', 'Kolkata', 'India'),
    ('Eden Gardens', None): ('Eden Gardens, Kolkata', 'Kolkata', 'India'),

    # ─── Headingley, Leeds (Leeds, England) ─
    ('Headingley, Leeds', 'Leeds'): ('Headingley, Leeds', 'Leeds', 'England'),
    ('Headingley', 'Leeds'): ('Headingley, Leeds', 'Leeds', 'England'),

    # ─── Trent Bridge, Nottingham (Nottingham, England) ─
    ('Trent Bridge, Nottingham', 'Nottingham'): ('Trent Bridge, Nottingham', 'Nottingham', 'England'),
    ('Trent Bridge', 'Nottingham'): ('Trent Bridge, Nottingham', 'Nottingham', 'England'),

    # ─── Wankhede Stadium, Mumbai (Mumbai, India) ─
    ('Wankhede Stadium', 'Mumbai'): ('Wankhede Stadium, Mumbai', 'Mumbai', 'India'),
    ...
    ('Old Trafford', 'Manchester'): ('Old Trafford, Manchester', 'Manchester', 'England'),

    # ─── Sophia Gardens, Cardiff (Cardiff, Wales) ─
    ('Sophia Gardens, Cardiff', 'Cardiff'): ('Sophia Gardens, Cardiff', 'Cardiff', 'Wales'),
    ('Sophia Gardens', 'Cardiff'): ('Sophia Gardens, Cardiff', 'Cardiff', 'Wales'),

    # ─── Zahur Ahmed Chowdhury Stadium, Chattogram (Chattogram, Bangladesh) ─
    ('Zahur Ahmed Chowdhury Stadium, Chattogram', 'Chattogram'): ('Zahur Ahmed Chowdhury Stadium, Chattogram', 'Chattogram', 'Bangladesh'),
    ('Zahur Ahmed Chowdhury Stadium, Chittagong', 'Chattogram'): ('Zahur Ahmed Chowdhury Stadium, Chattogram', 'Chattogram', 'Bangladesh'),
    ('Zahur Ahmed Chowdhury Stadium', 'Chittagong'): ('Zahur Ahmed Chowdhury Stadium, Chattogram', 'Chattogram', 'Bangladesh'),
    ('Zahur Ahmed Chowdhury Stadium', 'Chattogram'): ('Zahur Ahmed Chowdhury Stadium, Chattogram', 'Chattogram', 'Bangladesh'),

    # ─── R Premadasa Stadium, Colombo (Colombo, Sri Lanka) ─
    ('R Premadasa Stadium, Colombo', 'Colombo'): ('R Premadasa Stadium, Colombo', 'Colombo', 'Sri Lanka'),
    ('R Premadasa Stadium', 'Colombo'): ('R Premadasa Stadium, Colombo', 'Colombo', 'Sri Lanka'),

    # ─── Kingsmead, Durban (Durban, South Africa) ─
    ('Kingsmead, Durban', 'Durban'): ('Kingsmead, Durban', 'Durban', 'South Africa'),
    ('Kingsmead', 'Durban'): ('Kingsmead, Durban', 'Durban', 'South Africa'),

    # ─── M Chinnaswamy Stadium, Bengaluru (Bengaluru, India) ─
    ('M Chinnaswamy Stadium', 'Bangalore'): ('M Chinnaswamy Stadium, Bengaluru', 'Bengaluru', 'India'),
    ('M Chinnaswamy Stadium, Bengaluru', 'Bengaluru'): ('M Chinnaswamy Stadium, Bengaluru', 'Bengaluru', 'India'),
    ('M Chinnaswamy Stadium, Bangalore', 'Bengaluru'): ('M Chinnaswamy Stadium, Bengaluru', 'Bengaluru', 'India'),

    # ─── Hagley Oval, Christchurch (Christchurch, New Zealand) ─
    ('Hagley Oval, Christchurch', 'Christchurch'): ('Hagley Oval, Christchurch', 'Christchurch', 'New Zealand'),
    ('Hagley Oval', 'Christchurch'): ('Hagley Oval, Christchurch', 'Christchurch', 'New Zealand'),

    # ─── Bellerive Oval, Hobart (Hobart, Australia) ─
    ('Bellerive Oval, Hobart', 'Hobart'): ('Bellerive Oval, Hobart', 'Hobart', 'Australia'),
    ('Bellerive Oval', 'Hobart'): ('Bellerive Oval, Hobart', 'Hobart', 'Australia'),

    # ─── Feroz Shah Kotla (Delhi, India) ─
    ('Feroz Shah Kotla', 'Delhi'): ('Feroz Shah Kotla', 'Delhi', 'India'),

    # ─── Lord's, London (London, England) ─
    ("Lord's, London", 'London'): ("Lord's, London", 'London', 'England'),
    ("Lord's", 'London'): ("Lord's, London", 'London', 'England'),
    ...
    ('Botswana Cricket Association Oval 1, Gaborone', 'Gaborone'): ('Botswana Cricket Association Oval 1, Gaborone', 'Gaborone', 'Botswana'),
    ('Botswana Cricket Association Oval 1', 'Gaborone'): ('Botswana Cricket Association Oval 1, Gaborone', 'Gaborone', 'Botswana'),
    ...
    ('SuperSport Park, Centurion', 'Centurion'): ('SuperSport Park, Centurion', 'Centurion', 'South Africa'),
    ('SuperSport Park', 'Centurion'): ('SuperSport Park, Centurion', 'Centurion', 'South Africa'),

    # ─── Warner Park, Basseterre (Basseterre, Saint Kitts and Nevis) ─
    ('Warner Park, Basseterre, St Kitts', 'Basseterre'): ('Warner Park, Basseterre', 'Basseterre', 'Saint Kitts and Nevis'),
    ('Warner Park, Basseterre', 'St Kitts'): ('Warner Park, Basseterre', 'Basseterre', 'Saint Kitts and Nevis'),
    ('Warner Park, Basseterre', None): ('Warner Park, Basseterre', 'Basseterre', 'Saint Kitts and Nevis'),
    ('Warner Park, Basseterre', 'Basseterre'): ('Warner Park, Basseterre', 'Basseterre', 'Saint Kitts and Nevis'),

    # ─── West End Park International Cricket Stadium, Doha (Doha, Qatar) ─
    ('West End Park International Cricket Stadium, Doha', 'Doha'): ('West End Park International Cricket Stadium, Doha', 'Doha', 'Qatar'),
    ('West End Park International Cricket Stadium', 'Doha'): ('West End Park International Cricket Stadium, Doha', 'Doha', 'Qatar'),

    # ─── Newlands, Cape Town (Cape Town, South Africa) ─
    ('Newlands, Cape Town', 'Cape Town'): ('Newlands, Cape Town', 'Cape Town', 'South Africa'),
    ('Newlands', 'Cape Town'): ('Newlands, Cape Town', 'Cape Town', 'South Africa'),
    ...
    ('Basin Reserve, Wellington', 'Wellington'): ('Basin Reserve, Wellington', 'Wellington', 'New Zealand'),
    ('Basin Reserve', 'Wellington'): ('Basin Reserve, Wellington', 'Wellington', 'New Zealand'),
    ...
    ('Moara Vlasiei Cricket Ground, Ilfov County', 'Ilfov County'): ('Moara Vlasiei Cricket Ground, Ilfov County', 'Ilfov County', 'Romania'),
    ('Moara Vlasiei Cricket Ground', None): ('Moara Vlasiei Cricket Ground, Ilfov County', 'Ilfov County', 'Romania'),

    # ─── Queen's Park Oval, Port of Spain (Port of Spain, Trinidad and Tobago) ─
    ("Queen's Park Oval, Port of Spain", 'Trinidad'): ("Queen's Park Oval, Port of Spain", 'Port of Spain', 'Trinidad and Tobago'),
    ("Queen's Park Oval, Port of Spain, Trinidad", 'Port of Spain'): ("Queen's Park Oval, Port of Spain", 'Port of Spain', 'Trinidad and Tobago'),
    ("Queen's Park Oval, Port of Spain", 'Port of Spain'): ("Queen's Park Oval, Port of Spain", 'Port of Spain', 'Trinidad and Tobago'),

    # ─── Riverside Ground, Chester-le-Street (Chester-le-Street, England) ─
    ('Riverside Ground', 'Chester-le-Street'): ('Riverside Ground, Chester-le-Street', 'Chester-le-Street', 'England'),
    ('Riverside Ground, Chester-le-Street', 'Chester-le-Street'): ('Riverside Ground, Chester-le-Street', 'Chester-le-Street', 'England'),
    ...
    ("St George's Park, Port Elizabeth", 'Port Elizabeth'): ("St George's Park, Gqeberha", 'Gqeberha', 'South Africa'),
    ("St George's Park, Gqeberha", 'Gqeberha'): ("St George's Park, Gqeberha", 'Gqeberha', 'South Africa'),
    ("St George's Park", 'Port Elizabeth'): ("St George's Park, Gqeberha", 'Gqeberha', 'South Africa'),
    ...
    ('Docklands Stadium', 'Melbourne'): ('Docklands Stadium, Melbourne', 'Melbourne', 'Australia'),
    ('Docklands Stadium, Melbourne', 'Melbourne'): ('Docklands Stadium, Melbourne', 'Melbourne', 'Australia'),
    ...
    ('Sawai Mansingh Stadium', 'Jaipur'): ('Sawai Mansingh Stadium, Jaipur', 'Jaipur', 'India'),
    ('Sawai Mansingh Stadium, Jaipur', 'Jaipur'): ('Sawai Mansingh Stadium, Jaipur', 'Jaipur', 'India'),
    ...
    ('Senwes Park, Potchefstroom', 'Potchefstroom'): ('Senwes Park, Potchefstroom', 'Potchefstroom', 'South Africa'),
    ('Senwes Park', 'Potchefstroom'): ('Senwes Park, Potchefstroom', 'Potchefstroom', 'South Africa'),

    # ─── Boland Park, Paarl (Paarl, South Africa) ─
    ('Boland Park, Paarl', 'Paarl'): ('Boland Park, Paarl', 'Paarl', 'South Africa'),
    ('Boland Park', 'Paarl'): ('Boland Park, Paarl', 'Paarl', 'South Africa'),

    # ─── Kensington Oval, Bridgetown (Bridgetown, Barbados) ─
    ('Kensington Oval, Bridgetown', 'Barbados'): ('Kensington Oval, Bridgetown', 'Bridgetown', 'Barbados'),
    ('Kensington Oval, Bridgetown, Barbados', 'Bridgetown'): ('Kensington Oval, Bridgetown', 'Bridgetown', 'Barbados'),
    ('Kensington Oval, Bridgetown', 'Bridgetown'): ('Kensington Oval, Bridgetown', 'Bridgetown', 'Barbados'),

    # ─── Arun Jaitley Stadium, Delhi (Delhi, India) ─
    ('Arun Jaitley Stadium, Delhi', 'Delhi'): ('Arun Jaitley Stadium, Delhi', 'Delhi', 'India'),
    ('Arun Jaitley Stadium', None): ('Arun Jaitley Stadium, Delhi', 'Delhi', 'India'),
    ('Arun Jaitley Stadium', 'Delhi'): ('Arun Jaitley Stadium, Delhi', 'Delhi', 'India'),

    # ─── Botswana Cricket Association Oval 2, Gaborone (Gaborone, Botswana) ─
    ('Botswana Cricket Association Oval 2, Gaborone', 'Gaborone'): ('Botswana Cricket Association Oval 2, Gaborone', 'Gaborone', 'Botswana'),
    ('Botswana Cricket Association Oval 2', 'Gaborone'): ('Botswana Cricket Association Oval 2, Gaborone', 'Gaborone', 'Botswana'),
    ...
    ('Narendra Modi Stadium, Ahmedabad', 'Ahmedabad'): ('Narendra Modi Stadium, Ahmedabad', 'Ahmedabad', 'India'),
    ('Narendra Modi Stadium', 'Ahmedabad'): ('Narendra Modi Stadium, Ahmedabad', 'Ahmedabad', 'India'),
    ...
    ('Mission Road Ground, Mong Kok, Hong Kong', 'Mong Kok'): ('Mission Road Ground, Mong Kok', 'Mong Kok', 'Hong Kong'),
    ('Mission Road Ground, Mong Kok', 'Hong Kong'): ('Mission Road Ground, Mong Kok', 'Mong Kok', 'Hong Kong'),
    ('Mission Road Ground, Mong Kok', 'Mong Kok'): ('Mission Road Ground, Mong Kok', 'Mong Kok', 'Hong Kong'),

    # ─── St Lawrence Ground, Canterbury (Canterbury, England) ─
    ('St Lawrence Ground', 'Canterbury'): ('St Lawrence Ground, Canterbury', 'Canterbury', 'England'),
    ('St Lawrence Ground, Canterbury', 'Canterbury'): ('St Lawrence Ground, Canterbury', 'Canterbury', 'England'),
    ...
    ('UKM-YSD Cricket Oval, Bangi', 'Bangi'): ('UKM-YSD Cricket Oval, Bangi', 'Bangi', 'Malaysia'),
    ('UKM-YSD Cricket Oval', 'Bangi'): ('UKM-YSD Cricket Oval, Bangi', 'Bangi', 'Malaysia'),
    ...
    ('Daren Sammy National Cricket Stadium, Gros Islet, St Lucia', 'Gros Islet'): ('Daren Sammy National Cricket Stadium, Gros Islet', 'Gros Islet', 'Saint Lucia'),
    ('Daren Sammy National Cricket Stadium, Gros Islet', 'St Lucia'): ('Daren Sammy National Cricket Stadium, Gros Islet', 'Gros Islet', 'Saint Lucia'),
    ('Daren Sammy National Cricket Stadium, Gros Islet', 'Gros Islet'): ('Daren Sammy National Cricket Stadium, Gros Islet', 'Gros Islet', 'Saint Lucia'),
    ...
    ('North Sydney Oval', 'Sydney'): ('North Sydney Oval, Sydney', 'Sydney', 'Australia'),
    ('North Sydney Oval, Sydney', 'Sydney'): ('North Sydney Oval, Sydney', 'Sydney', 'Australia'),
    ...
    ('Brabourne Stadium, Mumbai', 'Mumbai'): ('Brabourne Stadium, Mumbai', 'Mumbai', 'India'),
    ('Brabourne Stadium', 'Mumbai'): ('Brabourne Stadium, Mumbai', 'Mumbai', 'India'),
    ...
    ('Manuka Oval', 'Canberra'): ('Manuka Oval, Canberra', 'Canberra', 'Australia'),
    ('Manuka Oval, Canberra', 'Canberra'): ('Manuka Oval, Canberra', 'Canberra', 'Australia'),
    ...
    ('Seddon Park', 'Hamilton'): ('Seddon Park, Hamilton', 'Hamilton', 'New Zealand'),
    ('Seddon Park, Hamilton', 'Hamilton'): ('Seddon Park, Hamilton', 'Hamilton', 'New Zealand'),

    # ─── Junction Oval, Melbourne (Melbourne, Australia) ─
    ('Junction Oval, Melbourne', 'Melbourne'): ('Junction Oval, Melbourne', 'Melbourne', 'Australia'),
    ('Junction Oval', 'Melbourne'): ('Junction Oval, Melbourne', 'Melbourne', 'Australia'),

    # ─── Sir Vivian Richards Stadium, North Sound (North Sound, Antigua and Barbuda) ─
    ('Sir Vivian Richards Stadium, North Sound, Antigua', 'North Sound'): ('Sir Vivian Richards Stadium, North Sound', 'North Sound', 'Antigua and Barbuda'),
    ('Sir Vivian Richards Stadium, North Sound', 'Antigua'): ('Sir Vivian Richards Stadium, North Sound', 'North Sound', 'Antigua and Barbuda'),
    ('Sir Vivian Richards Stadium, North Sound', 'North Sound'): ('Sir Vivian Richards Stadium, North Sound', 'North Sound', 'Antigua and Barbuda'),

    # ─── Brian Lara Stadium, Tarouba (Tarouba, Trinidad and Tobago) ─
    ('Brian Lara Stadium, Tarouba', 'Trinidad'): ('Brian Lara Stadium, Tarouba', 'Tarouba', 'Trinidad and Tobago'),
    ('Brian Lara Stadium, Tarouba, Trinidad', 'Tarouba'): ('Brian Lara Stadium, Tarouba', 'Tarouba', 'Trinidad and Tobago'),
    ('Brian Lara Stadium, Tarouba', 'Tarouba'): ('Brian Lara Stadium, Tarouba', 'Tarouba', 'Trinidad and Tobago'),
    ...
    ('Kinrara Academy Oval', 'Kuala Lumpur'): ('Kinrara Academy Oval, Kuala Lumpur', 'Kuala Lumpur', 'Malaysia'),
    ('Kinrara Academy Oval, Kuala Lumpur', 'Kuala Lumpur'): ('Kinrara Academy Oval, Kuala Lumpur', 'Kuala Lumpur', 'Malaysia'),
    ...
    ('ICC Academy, Dubai', 'Dubai'): ('ICC Academy, Dubai', 'Dubai', 'United Arab Emirates'),
    ('ICC Academy', 'Dubai'): ('ICC Academy, Dubai', 'Dubai', 'United Arab Emirates'),

    # ─── Western Australia Cricket Association Ground, Perth (Perth, Australia) ─
    ('Western Australia Cricket Association Ground', 'Perth'): ('Western Australia Cricket Association Ground, Perth', 'Perth', 'Australia'),
    ('Western Australia Cricket Association Ground, Perth', 'Perth'): ('Western Australia Cricket Association Ground, Perth', 'Perth', 'Australia'),
    ...
    ('Bay Oval, Mount Maunganui', 'Mount Maunganui'): ('Bay Oval, Mount Maunganui', 'Mount Maunganui', 'New Zealand'),
    ('Bay Oval', 'Mount Maunganui'): ('Bay Oval, Mount Maunganui', 'Mount Maunganui', 'New Zealand'),

    # ─── Bharat Ratna Shri Atal Bihari Vajpayee Ekana Cricket Stadium, Lucknow (Lucknow, India) ─
    ('Bharat Ratna Shri Atal Bihari Vajpayee Ekana Cricket Stadium, Lucknow', 'Lucknow'): ('Bharat Ratna Shri Atal Bihari Vajpayee Ekana Cricket Stadium, Lucknow', 'Lucknow', 'India'),
    ('Bharat Ratna Shri Atal Bihari Vajpayee Ekana Cricket Stadium', None): ('Bharat Ratna Shri Atal Bihari Vajpayee Ekana Cricket Stadium, Lucknow', 'Lucknow', 'India'),
    ('Bharat Ratna Shri Atal Bihari Vajpayee Ekana Cricket Stadium', 'Lucknow'): ('Bharat Ratna Shri Atal Bihari Vajpayee Ekana Cricket Stadium, Lucknow', 'Lucknow', 'India'),
    ...
    ('Willowmoore Park, Benoni', 'Benoni'): ('Willowmoore Park, Benoni', 'Benoni', 'South Africa'),
    ('Willowmoore Park', 'Benoni'): ('Willowmoore Park, Benoni', 'Benoni', 'South Africa'),
    ...
    ('Sabina Park, Kingston', 'Jamaica'): ('Sabina Park, Kingston', 'Kingston', 'Jamaica'),
    ('Sabina Park, Kingston, Jamaica', 'Kingston'): ('Sabina Park, Kingston', 'Kingston', 'Jamaica'),
    ('Sabina Park, Kingston', 'Kingston'): ('Sabina Park, Kingston', 'Kingston', 'Jamaica'),

    # ─── St Albans Club, Buenos Aires (Buenos Aires, Argentina) ─
    ('St Albans Club, Buenos Aires', 'Buenos Aires'): ('St Albans Club, Buenos Aires', 'Buenos Aires', 'Argentina'),

    # ─── Asian Institute of Technology Ground, Bangkok (Bangkok, Thailand) ─
    ('Asian Institute of Technology Ground', 'Bangkok'): ('Asian Institute of Technology Ground, Bangkok', 'Bangkok', 'Thailand'),
    ('Asian Institute of Technology Ground, Bangkok', 'Bangkok'): ('Asian Institute of Technology Ground, Bangkok', 'Bangkok', 'Thailand'),

    # ─── Eden Park, Auckland (Auckland, New Zealand) ─
    ('Eden Park', 'Auckland'): ('Eden Park, Auckland', 'Auckland', 'New Zealand'),
    ('Eden Park, Auckland', 'Auckland'): ('Eden Park, Auckland', 'Auckland', 'New Zealand'),
    ...
    ('Buffalo Park, East London', 'East London'): ('Buffalo Park, East London', 'East London', 'South Africa'),
    ('Buffalo Park', 'East London'): ('Buffalo Park, East London', 'East London', 'South Africa'),

    # ─── Karen Rolton Oval, Adelaide (Adelaide, Australia) ─
    ('Karen Rolton Oval, Adelaide', 'Adelaide'): ('Karen Rolton Oval, Adelaide', 'Adelaide', 'Australia'),
    ('Karen Rolton Oval', 'Adelaide'): ('Karen Rolton Oval, Adelaide', 'Adelaide', 'Australia'),
    ...
    ('Tafawa Balewa Square Cricket Oval, Lagos', 'Lagos'): ('Tafawa Balewa Square Cricket Oval, Lagos', 'Lagos', 'Nigeria'),
    ('Tafawa Balewa Square Cricket Oval', 'Lagos'): ('Tafawa Balewa Square Cricket Oval, Lagos', 'Lagos', 'Nigeria'),
    ...
    ('Dr DY Patil Sports Academy, Mumbai', 'Navi Mumbai'): ('Dr DY Patil Sports Academy, Navi Mumbai', 'Navi Mumbai', 'India'),
    ('Dr DY Patil Sports Academy', 'Mumbai'): ('Dr DY Patil Sports Academy, Navi Mumbai', 'Navi Mumbai', 'India'),
    ('Dr DY Patil Sports Academy, Navi Mumbai', 'Navi Mumbai'): ('Dr DY Patil Sports Academy, Navi Mumbai', 'Navi Mumbai', 'India'),
    ('Dr DY Patil Sports Academy, Mumbai', 'Mumbai'): ('Dr DY Patil Sports Academy, Navi Mumbai', 'Navi Mumbai', 'India'),
    ...
    ('United Cricket Club Ground, Windhoek', 'Windhoek'): ('United Cricket Club Ground, Windhoek', 'Windhoek', 'Namibia'),
    ('United Cricket Club Ground', 'Windhoek'): ('United Cricket Club Ground, Windhoek', 'Windhoek', 'Namibia'),
    ...
    ('Yeonhui Cricket Ground', 'Incheon'): ('Yeonhui Cricket Ground, Incheon', 'Incheon', 'South Korea'),
    ('Yeonhui Cricket Ground, Incheon', 'Incheon'): ('Yeonhui Cricket Ground, Incheon', 'Incheon', 'South Korea'),

    # ─── Barabati Stadium, Cuttack (Cuttack, India) ─
    ('Barabati Stadium', None): ('Barabati Stadium, Cuttack', 'Cuttack', 'India'),
    ('Barabati Stadium', 'Cuttack'): ('Barabati Stadium, Cuttack', 'Cuttack', 'India'),
    ('Barabati Stadium, Cuttack', 'Cuttack'): ('Barabati Stadium, Cuttack', 'Cuttack', 'India'),
    ...
    ('Maharashtra Cricket Association Stadium', 'Pune'): ('Maharashtra Cricket Association Stadium, Pune', 'Pune', 'India'),
    ('Maharashtra Cricket Association Stadium, Pune', 'Pune'): ('Maharashtra Cricket Association Stadium, Pune', 'Pune', 'India'),

    # ─── Nigeria Cricket Federation Oval 1, Abuja (Abuja, Nigeria) ─
    ('Nigeria Cricket Federation Oval 1, Abuja', 'Abuja'): ('Nigeria Cricket Federation Oval 1, Abuja', 'Abuja', 'Nigeria'),
    ...
    ('Queens Sports Club', 'Bulawayo'): ('Queens Sports Club, Bulawayo', 'Bulawayo', 'Zimbabwe'),

    # ─── YSD-UKM Cricket Oval, Bangi (Bangi, Malaysia) ─
    ('YSD-UKM Cricket Oval, Bangi', 'Bangi'): ('YSD-UKM Cricket Oval, Bangi', 'Bangi', 'Malaysia'),
    ...
    ('Achimota Senior Secondary School A Field, Accra', 'Accra'): ('Achimota Senior Secondary School A Field, Accra', 'Accra', 'Ghana'),

    # ─── Allan Border Field, Brisbane (Brisbane, Australia) ─
    ('Allan Border Field, Brisbane', 'Brisbane'): ('Allan Border Field, Brisbane', 'Brisbane', 'Australia'),
    ('Allan Border Field', 'Brisbane'): ('Allan Border Field, Brisbane', 'Brisbane', 'Australia'),
    ...
    ('Selangor Turf Club, Kuala Lumpur', 'Kuala Lumpur'): ('Selangor Turf Club, Kuala Lumpur', 'Kuala Lumpur', 'Malaysia'),

    # ─── Sportpark Maarschalkerweerd, Utrecht (Utrecht, Netherlands) ─
    ('Sportpark Maarschalkerweerd, Utrecht', 'Utrecht'): ('Sportpark Maarschalkerweerd, Utrecht', 'Utrecht', 'Netherlands'),
    ('Sportpark Maarschalkerweerd', 'Utrecht'): ('Sportpark Maarschalkerweerd, Utrecht', 'Utrecht', 'Netherlands'),

    # ─── McLean Park, Napier (Napier, New Zealand) ─
    ('McLean Park, Napier', 'Napier'): ('McLean Park, Napier', 'Napier', 'New Zealand'),
    ('McLean Park', 'Napier'): ('McLean Park, Napier', 'Napier', 'New Zealand'),
    ...
    ('Drummoyne Oval', 'Sydney'): ('Drummoyne Oval, Sydney', 'Sydney', 'Australia'),
    ('Drummoyne Oval, Sydney', 'Sydney'): ('Drummoyne Oval, Sydney', 'Sydney', 'Australia'),
    ...
    ('Simar Cricket Ground, Rome', 'Rome'): ('Simar Cricket Ground, Rome', 'Rome', 'Italy'),

    # ─── VRA Ground, Amstelveen (Amstelveen, Netherlands) ─
    ('VRA Ground', 'Amstelveen'): ('VRA Ground, Amstelveen', 'Amstelveen', 'Netherlands'),
    ('VRA Ground, Amstelveen', 'Amstelveen'): ('VRA Ground, Amstelveen', 'Amstelveen', 'Netherlands'),
    ...
    ('Amini Park, Port Moresby', 'Port Moresby'): ('Amini Park, Port Moresby', 'Port Moresby', 'Papua New Guinea'),
    ('Amini Park', 'Port Moresby'): ('Amini Park, Port Moresby', 'Port Moresby', 'Papua New Guinea'),
    ...
    ('Indian Association Ground', 'Singapore'): ('Indian Association Ground, Singapore', 'Singapore', 'Singapore'),
    ('Indian Association Ground, Singapore', 'Singapore'): ('Indian Association Ground, Singapore', 'Singapore', 'Singapore'),
    ...
    ('Maple Leaf North-West Ground', 'King City'): ('Maple Leaf North-West Ground, King City', 'King City', 'Canada'),

    # ─── Punjab Cricket Association IS Bindra Stadium, Mohali (Mohali, India) ─
    ('Punjab Cricket Association IS Bindra Stadium, Mohali', 'Chandigarh'): ('Punjab Cricket Association IS Bindra Stadium, Mohali', 'Mohali', 'India'),
    ('Punjab Cricket Association IS Bindra Stadium, Mohali, Chandigarh', 'Chandigarh'): ('Punjab Cricket Association IS Bindra Stadium, Mohali', 'Mohali', 'India'),
    ('Punjab Cricket Association IS Bindra Stadium', 'Chandigarh'): ('Punjab Cricket Association IS Bindra Stadium, Mohali', 'Mohali', 'India'),
    ('Punjab Cricket Association IS Bindra Stadium, Mohali', 'Mohali'): ('Punjab Cricket Association IS Bindra Stadium, Mohali', 'Mohali', 'India'),
    ...
    ('High Performance Oval, Windhoek', 'Windhoek'): ('High Performance Oval, Windhoek', 'Windhoek', 'Namibia'),

    # ─── King George V Sports Ground, Castel (Castel, Guernsey) ─
    ('King George V Sports Ground, Castel', 'Castel'): ('King George V Sports Ground, Castel', 'Castel', 'Guernsey'),
    ('King George V Sports Ground', 'Castel'): ('King George V Sports Ground, Castel', 'Castel', 'Guernsey'),
    ...
    ('Molyneux Park, Alexandra', 'Alexandra'): ('Molyneux Park, Alexandra', 'Alexandra', 'New Zealand'),
    ('Molyneux Park', 'Alexandra'): ('Molyneux Park, Alexandra', 'Alexandra', 'New Zealand'),

    # ─── National Sports Academy, Sofia (Sofia, Bulgaria) ─
    ('National Sports Academy, Sofia', 'Sofia'): ('National Sports Academy, Sofia', 'Sofia', 'Bulgaria'),

    # ─── Sikh Union Club Ground, Nairobi (Nairobi, Kenya) ─
    ('Sikh Union Club Ground, Nairobi', 'Nairobi'): ('Sikh Union Club Ground, Nairobi', 'Nairobi', 'Kenya'),

    # ─── Achimota Senior Secondary School B Field, Accra (Accra, Ghana) ─
    ('Achimota Senior Secondary School B Field, Accra', 'Accra'): ('Achimota Senior Secondary School B Field, Accra', 'Accra', 'Ghana'),
    ...
    ('Dr. Y.S. Rajasekhara Reddy ACA-VDCA Cricket Stadium, Visakhapatnam', 'Visakhapatnam'): ('Dr. Y.S. Rajasekhara Reddy ACA-VDCA Cricket Stadium, Visakhapatnam', 'Visakhapatnam', 'India'),
    ...
    ('Hurlingham Club Ground, Buenos Aires', 'Buenos Aires'): ('Hurlingham Club Ground, Buenos Aires', 'Buenos Aires', 'Argentina'),
    ...
    ('Pukekura Park, New Plymouth', 'New Plymouth'): ('Pukekura Park, New Plymouth', 'New Plymouth', 'New Zealand'),
    ('Pukekura Park', 'New Plymouth'): ('Pukekura Park, New Plymouth', 'New Plymouth', 'New Zealand'),

    # ─── Saurashtra Cricket Association Stadium, Rajkot (Rajkot, India) ─
    ('Saurashtra Cricket Association Stadium, Rajkot', 'Rajkot'): ('Saurashtra Cricket Association Stadium, Rajkot', 'Rajkot', 'India'),
    ('Saurashtra Cricket Association Stadium', 'Rajkot'): ('Saurashtra Cricket Association Stadium, Rajkot', 'Rajkot', 'India'),
    ('Saurashtra Cricket Association Stadium', None): ('Saurashtra Cricket Association Stadium, Rajkot', 'Rajkot', 'India'),

    # ─── Sportpark Het Schootsveld, Deventer (Deventer, Netherlands) ─
    ('Sportpark Het Schootsveld', 'Deventer'): ('Sportpark Het Schootsveld, Deventer', 'Deventer', 'Netherlands'),
    ('Sportpark Het Schootsveld, Deventer', 'Deventer'): ('Sportpark Het Schootsveld, Deventer', 'Deventer', 'Netherlands'),

    # ─── Vassil Levski National Sports Academy, Sofia (Sofia, Bulgaria) ─
    ('Vassil Levski National Sports Academy, Sofia', 'Sofia'): ('Vassil Levski National Sports Academy, Sofia', 'Sofia', 'Bulgaria'),
    ...
    ('Church Street Park, Morrisville', 'Morrisville'): ('Church Street Park, Morrisville', 'Morrisville', 'USA'),
    ('Church Street Park', 'Morrisville'): ('Church Street Park, Morrisville', 'Morrisville', 'USA'),
    ...
    ('Namibia Cricket Ground, Windhoek', 'Windhoek'): ('Namibia Cricket Ground, Windhoek', 'Windhoek', 'Namibia'),

    # ─── Shaheed Veer Narayan Singh International Stadium, Raipur (Raipur, India) ─
    ('Shaheed Veer Narayan Singh International Stadium', None): ('Shaheed Veer Narayan Singh International Stadium, Raipur', 'Raipur', 'India'),
    ('Shaheed Veer Narayan Singh International Stadium', 'Raipur'): ('Shaheed Veer Narayan Singh International Stadium, Raipur', 'Raipur', 'India'),
    ('Shaheed Veer Narayan Singh International Stadium, Raipur', 'Raipur'): ('Shaheed Veer Narayan Singh International Stadium, Raipur', 'Raipur', 'India'),

    # ─── TCA Oval, Blantyre (Blantyre, Malawi) ─
    ('TCA Oval, Blantyre', 'Blantyre'): ('TCA Oval, Blantyre', 'Blantyre', 'Malawi'),
    ...
    ('Diamond Oval, Kimberley', 'Kimberley'): ('Diamond Oval, Kimberley', 'Kimberley', 'South Africa'),

    # ─── GB Oval, Szodliget (Szodliget, Hungary) ─
    ('GB Oval, Szodliget', 'Szodliget'): ('GB Oval, Szodliget', 'Szodliget', 'Hungary'),
    ...
    ('Guernsey Rovers Athletic Club Ground, Port Soif', 'Port  Soif'): ('Guernsey Rovers Athletic Club Ground, Port Soif', 'Port Soif', 'Guernsey'),
    ('Guernsey Rovers Athletic Club Ground, Port Soif', 'Port Soif'): ('Guernsey Rovers Athletic Club Ground, Port Soif', 'Port Soif', 'Guernsey'),

    # ─── Holkar Cricket Stadium, Indore (Indore, India) ─
    ('Holkar Cricket Stadium, Indore', 'Indore'): ('Holkar Cricket Stadium, Indore', 'Indore', 'India'),
    ('Holkar Cricket Stadium', 'Indore'): ('Holkar Cricket Stadium, Indore', 'Indore', 'India'),

    # ─── JSCA International Stadium Complex, Ranchi (Ranchi, India) ─
    ('JSCA International Stadium Complex, Ranchi', 'Ranchi'): ('JSCA International Stadium Complex, Ranchi', 'Ranchi', 'India'),
    ('JSCA International Stadium Complex', None): ('JSCA International Stadium Complex, Ranchi', 'Ranchi', 'India'),
    ('JSCA International Stadium Complex', 'Ranchi'): ('JSCA International Stadium Complex, Ranchi', 'Ranchi', 'India'),
    ...
    ('Saxton Oval, Nelson', 'Nelson'): ('Saxton Oval, Nelson', 'Nelson', 'New Zealand'),
    ('Saxton Oval', 'Nelson'): ('Saxton Oval, Nelson', 'Nelson', 'New Zealand'),
    ...
    ('Albert Park 1, Suva', 'Suva'): ('Albert Park 1, Suva', 'Suva', 'Fiji'),
    ('Albert Park 1', 'Suva'): ('Albert Park 1, Suva', 'Suva', 'Fiji'),
    ...
    ('College Ground', 'Cheltenham'): ('College Ground, Cheltenham', 'Cheltenham', 'England'),
    ('College Ground, Cheltenham', 'Cheltenham'): ('College Ground, Cheltenham', 'Cheltenham', 'England'),
    ...
    ('Faleata Oval No 2, Apia', 'Apia'): ('Faleata Oval No 2, Apia', 'Apia', 'Samoa'),
    ...
    ('Haslegrave Ground, Loughborough', 'Loughborough'): ('Haslegrave Ground, Loughborough', 'Loughborough', 'England'),
    ('Haslegrave Ground', 'Loughborough'): ('Haslegrave Ground, Loughborough', 'Loughborough', 'England'),

    # ─── Hazelaarweg, Rotterdam (Rotterdam, Netherlands) ─
    ('Hazelaarweg, Rotterdam', 'Rotterdam'): ('Hazelaarweg, Rotterdam', 'Rotterdam', 'Netherlands'),
    ('Hazelaarweg', 'Rotterdam'): ('Hazelaarweg, Rotterdam', 'Rotterdam', 'Netherlands'),

    # ─── John Davies Oval, Queenstown (Queenstown, New Zealand) ─
    ('John Davies Oval, Queenstown', 'Queenstown'): ('John Davies Oval, Queenstown', 'Queenstown', 'New Zealand'),
    ...
    ('Woodley Cricket Field, Los Angeles', 'Los Angeles'): ('Woodley Cricket Field, Los Angeles', 'Los Angeles', 'USA'),
    ...
    ('Aurora Stadium', 'Launceston'): ('Aurora Stadium, Launceston', 'Launceston', 'Australia'),
    ('Aurora Stadium, Launceston', 'Launceston'): ('Aurora Stadium, Launceston', 'Launceston', 'Australia'),

    # ─── Barsapara Cricket Stadium, Guwahati (Guwahati, India) ─
    ('Barsapara Cricket Stadium, Guwahati', 'Guwahati'): ('Barsapara Cricket Stadium, Guwahati', 'Guwahati', 'India'),
    ('ACA Stadium, Barsapara', None): ('Barsapara Cricket Stadium, Guwahati', 'Guwahati', 'India'),
    ('Barsapara Cricket Stadium', 'Guwahati'): ('Barsapara Cricket Stadium, Guwahati', 'Guwahati', 'India'),

    # ─── Blacktown International Sportspark, Sydney (Sydney, Australia) ─
    ('Blacktown International Sportspark', 'Sydney'): ('Blacktown International Sportspark, Sydney', 'Sydney', 'Australia'),
    ('Blacktown International Sportspark, Sydney', 'Sydney'): ('Blacktown International Sportspark, Sydney', 'Sydney', 'Australia'),
    ...
    ('ICC Academy Ground No 2', 'Dubai'): ('ICC Academy Ground No 2, Dubai', 'Dubai', 'United Arab Emirates'),
    ('ICC Academy Ground No 2, Dubai', 'Dubai'): ('ICC Academy Ground No 2, Dubai', 'Dubai', 'United Arab Emirates'),

    # ─── Mangaung Oval, Bloemfontein (Bloemfontein, South Africa) ─
    ('Mangaung Oval, Bloemfontein', 'Bloemfontein'): ('Mangaung Oval, Bloemfontein', 'Bloemfontein', 'South Africa'),
    ('Mangaung Oval', 'Bloemfontein'): ('Mangaung Oval, Bloemfontein', 'Bloemfontein', 'South Africa'),

    # ─── Ray Mitchell Oval, Harrup Park, Mackay (Mackay, Australia) ─
    ('Ray Mitchell Oval, Harrup Park, Mackay', 'Mackay'): ('Ray Mitchell Oval, Harrup Park, Mackay', 'Mackay', 'Australia'),

    # ─── Reforma Athletic Club, Naucalpan (Naucalpan, Mexico) ─
    ('Reforma Athletic Club, Naucalpan', 'Naucalpan'): ('Reforma Athletic Club, Naucalpan', 'Naucalpan', 'Mexico'),
    ...
    ('Stars Arena Hofstade, Zemst', 'Zemst'): ('Stars Arena Hofstade, Zemst', 'Zemst', 'Belgium'),

    # ─── Svanholm Park, Brondby (Brondby, Denmark) ─
    ('Svanholm Park, Brondby', 'Brondby'): ('Svanholm Park, Brondby', 'Brondby', 'Denmark'),
    ...
    ('Belgrano Athletic Club Ground, Buenos Aires', 'Buenos Aires'): ('Belgrano Athletic Club Ground, Buenos Aires', 'Buenos Aires', 'Argentina'),

    # ─── Centre for Cricket Development Ground, Windhoek (Windhoek, Namibia) ─
    ('Centre for Cricket Development Ground, Windhoek', 'Windhoek'): ('Centre for Cricket Development Ground, Windhoek', 'Windhoek', 'Namibia'),

    # ─── Chevrolet Park, Bloemfontein (Bloemfontein, South Africa) ─
    ('Chevrolet Park, Bloemfontein', 'Bloemfontein'): ('Chevrolet Park, Bloemfontein', 'Bloemfontein', 'South Africa'),
    ...
    ('Fitzherbert Park, Palmerston North', 'Palmerston North'): ('Fitzherbert Park, Palmerston North', 'Palmerston North', 'New Zealand'),
    ...
    ('Independence Park, Port Vila', 'Port Vila'): ('Independence Park, Port Vila', 'Port Vila', 'Vanuatu'),
    ...
    ('Lilac Hill Park', 'Perth'): ('Lilac Hill Park, Perth', 'Perth', 'Australia'),
    ('Lilac Hill Park, Perth', 'Perth'): ('Lilac Hill Park, Perth', 'Perth', 'Australia'),
    ...
    ("National Cricket Stadium, St George's, Grenada", "St George's"): ("National Cricket Stadium, St George's", "St George's", 'Grenada'),
    ("National Cricket Stadium, St George's", 'Grenada'): ("National Cricket Stadium, St George's", "St George's", 'Grenada'),
    ("National Cricket Stadium, St George's", "St George's"): ("National Cricket Stadium, St George's", "St George's", 'Grenada'),
    ...
    ('Royal Brussels Cricket Club Ground, Waterloo', 'Waterloo'): ('Royal Brussels Cricket Club Ground, Waterloo', 'Waterloo', 'Belgium'),
    ...
    ('Albert Park 2, Suva', 'Suva'): ('Albert Park 2, Suva', 'Suva', 'Fiji'),
    ('Albert Park 2', 'Suva'): ('Albert Park 2, Suva', 'Suva', 'Fiji'),

    # ─── Arnos Vale Ground, Kingstown (Kingstown, Saint Vincent and the Grenadines) ─
    ('Arnos Vale Ground, Kingstown, St Vincent', 'Kingstown'): ('Arnos Vale Ground, Kingstown', 'Kingstown', 'Saint Vincent and the Grenadines'),
    ('Arnos Vale Ground, Kingstown', 'St Vincent'): ('Arnos Vale Ground, Kingstown', 'Kingstown', 'Saint Vincent and the Grenadines'),
    ('Arnos Vale Ground, Kingstown', 'Kingstown'): ('Arnos Vale Ground, Kingstown', 'Kingstown', 'Saint Vincent and the Grenadines'),
    ...
    ('Marina Ground, Corfu', 'Corfu'): ('Marina Ground, Corfu', 'Corfu', 'Greece'),

    # ─── Mladost Cricket Ground, Zagreb (Zagreb, Croatia) ─
    ('Mladost Cricket Ground, Zagreb', 'Zagreb'): ('Mladost Cricket Ground, Zagreb', 'Zagreb', 'Croatia'),
    ...
    ("St George's College Ground, Buenos Aires", 'Buenos Aires'): ("St George's College Ground, Buenos Aires", 'Buenos Aires', 'Argentina'),
    ...
    ('Velden Cricket Ground, Latschach', 'Latschach'): ('Velden Cricket Ground, Latschach', 'Latschach', 'Austria'),

    # ─── Goldenacre, Edinburgh (Edinburgh, Scotland) ─
    ('Goldenacre, Edinburgh', 'Edinburgh'): ('Goldenacre, Edinburgh', 'Edinburgh', 'Scotland'),
    ('Goldenacre', 'Edinburgh'): ('Goldenacre, Edinburgh', 'Edinburgh', 'Scotland'),

    # ─── Grainville, St Saviour (St Saviour, Jersey) ─
    ('Grainville, St Saviour, Jersey', 'St Saviour'): ('Grainville, St Saviour', 'St Saviour', 'Jersey'),
    ('Grainville, St Saviour', 'St Saviour'): ('Grainville, St Saviour', 'St Saviour', 'Jersey'),
    ...
    ('Nassau County International Cricket Stadium, New York', 'New York'): ('Nassau County International Cricket Stadium, New York', 'New York', 'USA'),
    ...
    ('Sinhalese Sports Club Ground, Colombo', 'Colombo'): ('Sinhalese Sports Club Ground, Colombo', 'Colombo', 'Sri Lanka'),
    ('Sinhalese Sports Club Ground', 'Colombo'): ('Sinhalese Sports Club Ground, Colombo', 'Colombo', 'Sri Lanka'),
    ...
    ('Castle Avenue, Dublin', 'Dublin'): ('Castle Avenue, Dublin', 'Dublin', 'Ireland'),

    # ─── Clayton Panama, Panama City (Panama City, Panama) ─
    ('Clayton Panama, Panama City', 'Panama City'): ('Clayton Panama, Panama City', 'Panama City', 'Panama'),
    ...
    ('Great Barrier Reef Arena, Mackay', 'Mackay'): ('Great Barrier Reef Arena, Mackay', 'Mackay', 'Australia'),
    ...
    ('Radlett Cricket Club, Radlett', 'Radlett'): ('Radlett Cricket Club, Radlett', 'Radlett', 'England'),
    ('Radlett Cricket Club', 'Radlett'): ('Radlett Cricket Club, Radlett', 'Radlett', 'England'),

    # ─── Sheikh Abu Naser Stadium, Khulna (Khulna, Bangladesh) ─
    ('Sheikh Abu Naser Stadium, Khulna', 'Khulna'): ('Sheikh Abu Naser Stadium, Khulna', 'Khulna', 'Bangladesh'),
    ('Sheikh Abu Naser Stadium', 'Khulna'): ('Sheikh Abu Naser Stadium, Khulna', 'Khulna', 'Bangladesh'),
    ...
    ('Stanley Park, Blackpool', 'Blackpool'): ('Stanley Park, Blackpool', 'Blackpool', 'England'),
    ...
    ('Woodbridge Road, Guildford', 'Guildford'): ('Woodbridge Road, Guildford', 'Guildford', 'England'),
    ...
    ('Bir Sreshtho Flight Lieutenant Matiur Rahman Stadium, Chattogram', 'Chattogram'): ('Bir Sreshtho Flight Lieutenant Matiur Rahman Stadium, Chattogram', 'Chattogram', 'Bangladesh'),
    ...
    ('Greenfield International Stadium', 'Thiruvananthapuram'): ('Greenfield International Stadium, Thiruvananthapuram', 'Thiruvananthapuram', 'India'),
    ...
    ('Royal Selangor Club', 'Kuala Lumpur'): ('Royal Selangor Club, Kuala Lumpur', 'Kuala Lumpur', 'Malaysia'),
    ('Royal Selangor Club, Kuala Lumpur', 'Kuala Lumpur'): ('Royal Selangor Club, Kuala Lumpur', 'Kuala Lumpur', 'Malaysia'),

    # ─── Ruaraka Sports Club Ground, Nairobi (Nairobi, Kenya) ─
    ('Ruaraka Sports Club Ground, Nairobi', 'Nairobi'): ('Ruaraka Sports Club Ground, Nairobi', 'Nairobi', 'Kenya'),

    # ─── Simonds Stadium, South Geelong (South Geelong, Australia) ─
    ('Simonds Stadium, South Geelong, Victoria', 'Geelong'): ('Simonds Stadium, South Geelong', 'South Geelong', 'Australia'),
    ('Simonds Stadium, South Geelong', 'Victoria'): ('Simonds Stadium, South Geelong', 'South Geelong', 'Australia'),
    ('Simonds Stadium, South Geelong', 'South Geelong'): ('Simonds Stadium, South Geelong', 'South Geelong', 'Australia'),
    ...
    ('Titwood, Glasgow', 'Glasgow'): ('Titwood, Glasgow', 'Glasgow', 'Scotland'),
    ...
    ('College Field', 'St Peter Port'): ('College Field, St Peter Port', 'St Peter Port', 'Guernsey'),
    ('College Field, St Peter Port', 'St Peter Port'): ('College Field, St Peter Port', 'St Peter Port', 'Guernsey'),

    # ─── De Beers Diamond Oval, Kimberley (Kimberley, South Africa) ─
    ('De Beers Diamond Oval, Kimberley', 'Kimberley'): ('De Beers Diamond Oval, Kimberley', 'Kimberley', 'South Africa'),
    ('De Beers Diamond Oval', 'Kimberley'): ('De Beers Diamond Oval, Kimberley', 'Kimberley', 'South Africa'),
    ...
    ('FB Fields, St Clement', 'St Clement'): ('FB Fields, St Clement', 'St Clement', 'Jersey'),
    ...
    ('Lugogo Cricket Oval, Kampala', 'Kampala'): ('Lugogo Cricket Oval, Kampala', 'Kampala', 'Uganda'),
    ('Lugogo Cricket Oval', 'Kampala'): ('Lugogo Cricket Oval, Kampala', 'Kampala', 'Uganda'),
    ...
    ("Merchant Taylors' School Ground, Northwood", 'Northwood'): ("Merchant Taylors' School Ground, Northwood", 'Northwood', 'England'),
    ("Merchant Taylors' School Ground", 'Northwood'): ("Merchant Taylors' School Ground, Northwood", 'Northwood', 'England'),
    ...
    ('Nigeria Cricket Federation Oval 2, Abuja', 'Abuja'): ('Nigeria Cricket Federation Oval 2, Abuja', 'Abuja', 'Nigeria'),
    ...
    ('Sky Stadium, Wellington', 'Wellington'): ('Sky Stadium, Wellington', 'Wellington', 'New Zealand'),
    ('Sky Stadium', 'Wellington'): ('Sky Stadium, Wellington', 'Wellington', 'New Zealand'),

    # ─── Southend Club Cricket Stadium, Karachi (Karachi, Pakistan) ─
    ('Southend Club Cricket Stadium', 'Karachi'): ('Southend Club Cricket Stadium, Karachi', 'Karachi', 'Pakistan'),
    ('Southend Club Cricket Stadium, Karachi', 'Karachi'): ('Southend Club Cricket Stadium, Karachi', 'Karachi', 'Pakistan'),
    ...
    ('University of Tasmania Stadium, Launceston', 'Launceston'): ('University of Tasmania Stadium, Launceston', 'Launceston', 'Australia'),
    ...
    ('7he Sevens Stadium, Dubai', 'Dubai'): ('7he Sevens Stadium, Dubai', 'Dubai', 'United Arab Emirates'),
    ...
    ('Aigburth, Liverpool', 'Liverpool'): ('Aigburth, Liverpool', 'Liverpool', 'England'),
    ('Aigburth', 'Liverpool'): ('Aigburth, Liverpool', 'Liverpool', 'England'),
    ...
    ('Eastern Oval, Ballarat', 'Ballarat'): ('Eastern Oval, Ballarat', 'Ballarat', 'Australia'),
    ('Eastern Oval', 'Ballarat'): ('Eastern Oval, Ballarat', 'Ballarat', 'Australia'),
    ...
    ('International Sports Stadium, Coffs Harbour', 'Coffs Harbour'): ('International Sports Stadium, Coffs Harbour', 'Coffs Harbour', 'Australia'),
    ('International Sports Stadium', 'Coffs Harbour'): ('International Sports Stadium, Coffs Harbour', 'Coffs Harbour', 'Australia'),
    ...
    ('Maharaja Yadavindra Singh International Cricket Stadium, New Chandigarh', 'New Chandigarh'): ('Maharaja Yadavindra Singh International Cricket Stadium, New Chandigarh', 'New Chandigarh', 'India'),

    # ─── Malek Cricket Ground, Ajman (Ajman, United Arab Emirates) ─
    ('Malek Cricket Ground, Ajman', 'Ajman'): ('Malek Cricket Ground, Ajman', 'Ajman', 'United Arab Emirates'),

    # ─── Maple Leaf North-East Ground, King City (King City, Canada) ─
    ('Maple Leaf North-East Ground, King City', 'King City'): ('Maple Leaf North-East Ground, King City', 'King City', 'Canada'),
    ...
    ('P Sara Oval', 'Colombo'): ('P Sara Oval, Colombo', 'Colombo', 'Sri Lanka'),
    ('P Sara Oval, Colombo', 'Colombo'): ('P Sara Oval, Colombo', 'Colombo', 'Sri Lanka'),
    ...
    ('Seebarn Cricket Centre', 'Lower Austria'): ('Seebarn Cricket Centre, Lower Austria', 'Lower Austria', 'Austria'),
    ('Seebarn Cricket Centre, Lower Austria', 'Lower Austria'): ('Seebarn Cricket Centre, Lower Austria', 'Lower Austria', 'Austria'),
    ...
    ('Clifton Park Ground, York', 'York'): ('Clifton Park Ground, York', 'York', 'England'),

    # ─── Clontarf Cricket Club Ground, Dublin (Dublin, Ireland) ─
    ('Clontarf Cricket Club Ground', 'Dublin'): ('Clontarf Cricket Club Ground, Dublin', 'Dublin', 'Ireland'),
    ('Clontarf Cricket Club Ground, Dublin', 'Dublin'): ('Clontarf Cricket Club Ground, Dublin', 'Dublin', 'Ireland'),
    ...
    ('Cricket Central, Sydney', 'Sydney'): ('Cricket Central, Sydney', 'Sydney', 'Australia'),
    ...
    ('Ekeberg Cricket Ground 1, Oslo', 'Oslo'): ('Ekeberg Cricket Ground 1, Oslo', 'Oslo', 'Norway'),
    ...
    ('New Farnley CC, Leeds', 'Leeds'): ('New Farnley CC, Leeds', 'Leeds', 'England'),
    ...
    ('Sportpark Harga, Schiedam', 'Schiedam'): ('Sportpark Harga, Schiedam', 'Schiedam', 'Netherlands'),
    ...
    ('Stubberudmyra Cricket Ground, Oslo', 'Oslo'): ('Stubberudmyra Cricket Ground, Oslo', 'Oslo', 'Norway'),

    # ─── Ted Summerton Reserve, Moe (Moe, Australia) ─
    ('Ted Summerton Reserve, Moe', 'Moe'): ('Ted Summerton Reserve, Moe', 'Moe', 'Australia'),
    ('Ted Summerton Reserve', 'Moe'): ('Ted Summerton Reserve, Moe', 'Moe', 'Australia'),
    ...
    ('Ballpark Ground, Graz', 'Graz'): ('Ballpark Ground, Graz', 'Graz', 'Austria'),
    ...
    ("Cazaly's Stadium, Cairns", 'Cairns'): ("Cazaly's Stadium, Cairns", 'Cairns', 'Australia'),
    ("Cazaly's Stadium", 'Cairns'): ("Cazaly's Stadium, Cairns", 'Cairns', 'Australia'),

    # ─── City Oval, Pietermaritzburg (Pietermaritzburg, South Africa) ─
    ('City Oval', 'Pietermaritzburg'): ('City Oval, Pietermaritzburg', 'Pietermaritzburg', 'South Africa'),
    ('City Oval, Pietermaritzburg', 'Pietermaritzburg'): ('City Oval, Pietermaritzburg', 'Pietermaritzburg', 'South Africa'),

    # ─── Cobham Oval (New), Whangarei (Whangarei, New Zealand) ─
    ('Cobham Oval (New), Whangarei', 'Whangarei'): ('Cobham Oval (New), Whangarei', 'Whangarei', 'New Zealand'),
    ...
    ('Invermay Park, Launceston', 'Launceston'): ('Invermay Park, Launceston', 'Launceston', 'Australia'),
    ('Invermay Park', 'Launceston'): ('Invermay Park, Launceston', 'Launceston', 'Australia'),

    # ─── Jadavpur University Campus 2nd Ground, Kolkata (Kolkata, India) ─
    ('Jadavpur University Campus 2nd Ground, Kolkata', 'Kolkata'): ('Jadavpur University Campus 2nd Ground, Kolkata', 'Kolkata', 'India'),
    ...
    ('Latrobe Recreation Ground, Latrobe', 'Latrobe'): ('Latrobe Recreation Ground, Latrobe', 'Latrobe', 'Australia'),

    # ─── Lavington Sports Oval, Albury (Albury, Australia) ─
    ('Lavington Sports Oval', 'Albury'): ('Lavington Sports Oval, Albury', 'Albury', 'Australia'),
    ('Lavington Sports Oval, Albury', 'Albury'): ('Lavington Sports Oval, Albury', 'Albury', 'Australia'),

    # ─── Malahide, Dublin (Dublin, Ireland) ─
    ('Malahide, Dublin', 'Dublin'): ('Malahide, Dublin', 'Dublin', 'Ireland'),

    # ─── Marrara Stadium, Darwin (Darwin, Australia) ─
    ('Marrara Stadium, Darwin', 'Darwin'): ('Marrara Stadium, Darwin', 'Darwin', 'Australia'),
    ...
    ('North Marine Road Ground, Scarborough', 'Scarborough'): ('North Marine Road Ground, Scarborough', 'Scarborough', 'England'),
    ...
    ('Windsor Park, Roseau', 'Dominica'): ('Windsor Park, Roseau', 'Roseau', 'Dominica'),
    ('Windsor Park, Roseau, Dominica', 'Roseau'): ('Windsor Park, Roseau', 'Roseau', 'Dominica'),
    ('Windsor Park, Roseau', 'Roseau'): ('Windsor Park, Roseau', 'Roseau', 'Dominica'),
    ...
    ('Boughton Hall Cricket Club Ground, Chester', 'Chester'): ('Boughton Hall Cricket Club Ground, Chester', 'Chester', 'England'),

    # ─── Casey Fields No 4, Melbourne (Melbourne, Australia) ─
    ('Casey Fields No 4, Melbourne', 'Melbourne'): ('Casey Fields No 4, Melbourne', 'Melbourne', 'Australia'),
    ...
    ('Ekeberg Cricket Ground 2, Oslo', 'Oslo'): ('Ekeberg Cricket Ground 2, Oslo', 'Oslo', 'Norway'),
    ...
    ('Jubilee Park, Ringwood, Melbourne', 'Melbourne'): ('Jubilee Park, Ringwood, Melbourne', 'Melbourne', 'Australia'),
    ...
    ('Shrimant Madhavrao Scindia Cricket Stadium, Gwalior', 'Gwalior'): ('Shrimant Madhavrao Scindia Cricket Stadium, Gwalior', 'Gwalior', 'India'),
    ...
    ('Trafalgar Road Ground, Southport', 'Southport'): ('Trafalgar Road Ground, Southport', 'Southport', 'England'),
