...
VENUE_ALIASES: dict[tuple[str, Optional[str]], tuple[str, str, str]] = {
    ...
    # only under a longer ", <city>"-suffixed key, so the stored short
    # name did not resolve back to a country. These self-referential keys
    # make each stored name round-trip, so scripts/fix_venue_names.py no
    # longer re-flags them as unknown. Auto-generated from the DB; no data
    # change, purely a resolver-completeness fix.

    ('7he Sevens Stadium', 'Dubai'): ('7he Sevens Stadium', 'Dubai', 'United Arab Emirates'),
    ('Achimota Senior Secondary School A Field', 'Accra'): ('Achimota Senior Secondary School A Field', 'Accra', 'Ghana'),
    ('Achimota Senior Secondary School B Field', 'Accra'): ('Achimota Senior Secondary School B Field', 'Accra', 'Ghana'),
    ('Arnos Vale Ground', 'Kingstown'): ('Arnos Vale Ground', 'Kingstown', 'Saint Vincent and the Grenadines'),
    ('Ballpark Ground', 'Graz'): ('Ballpark Ground', 'Graz', 'Austria'),
    ('Belgrano Athletic Club Ground', 'Buenos Aires'): ('Belgrano Athletic Club Ground', 'Buenos Aires', 'Argentina'),
    ('Bir Sreshtho Flight Lieutenant Matiur Rahman Stadium', 'Chattogram'): ('Bir Sreshtho Flight Lieutenant Matiur Rahman Stadium', 'Chattogram', 'Bangladesh'),
    ('Botkyrka Cricket Center', 'Stockholm'): ('Botkyrka Cricket Center', 'Stockholm', 'Sweden'),
    ('Boughton Hall Cricket Club Ground', 'Chester'): ('Boughton Hall Cricket Club Ground', 'Chester', 'England'),
    ('Brian Lara Stadium', 'Tarouba'): ('Brian Lara Stadium', 'Tarouba', 'Trinidad and Tobago'),
    ('Casey Fields No 4', 'Melbourne'): ('Casey Fields No 4', 'Melbourne', 'Australia'),
    ('Castle Avenue', 'Dublin'): ('Castle Avenue', 'Dublin', 'Ireland'),
    ('Centre for Cricket Development Ground', 'Windhoek'): ('Centre for Cricket Development Ground', 'Windhoek', 'Namibia'),
    ('Chevrolet Park', 'Bloemfontein'): ('Chevrolet Park', 'Bloemfontein', 'South Africa'),
    ('Clayton Panama', 'Panama City'): ('Clayton Panama', 'Panama City', 'Panama'),
    ('Clifton Park Ground', 'York'): ('Clifton Park Ground', 'York', 'England'),
    ('Cobham Oval (New)', 'Whangarei'): ('Cobham Oval (New)', 'Whangarei', 'New Zealand'),
    ('Cricket Central', 'Sydney'): ('Cricket Central', 'Sydney', 'Australia'),
    ('Daren Sammy National Cricket Stadium', 'Gros Islet'): ('Daren Sammy National Cricket Stadium', 'Gros Islet', 'Saint Lucia'),
    ('Diamond Oval', 'Kimberley'): ('Diamond Oval', 'Kimberley', 'South Africa'),
    ('Dr DY Patil Sports Academy', 'Navi Mumbai'): ('Dr DY Patil Sports Academy', 'Navi Mumbai', 'India'),
    ('Ekeberg Cricket Ground 1', 'Oslo'): ('Ekeberg Cricket Ground 1', 'Oslo', 'Norway'),
    ('Ekeberg Cricket Ground 2', 'Oslo'): ('Ekeberg Cricket Ground 2', 'Oslo', 'Norway'),
    ('FB Fields', 'St Clement'): ('FB Fields', 'St Clement', 'Jersey'),
    ('Faleata Oval No 2', 'Apia'): ('Faleata Oval No 2', 'Apia', 'Samoa'),
    ('Fitzherbert Park', 'Palmerston North'): ('Fitzherbert Park', 'Palmerston North', 'New Zealand'),
    ('GB Oval', 'Szodliget'): ('GB Oval', 'Szodliget', 'Hungary'),
    ('Grainville', 'St Saviour'): ('Grainville', 'St Saviour', 'Jersey'),
    ('Great Barrier Reef Arena', 'Mackay'): ('Great Barrier Reef Arena', 'Mackay', 'Australia'),
    ('Guernsey Rovers Athletic Club Ground', 'Port Soif'): ('Guernsey Rovers Athletic Club Ground', 'Port Soif', 'Guernsey'),
    ('High Performance Oval', 'Windhoek'): ('High Performance Oval', 'Windhoek', 'Namibia'),
    ('Hurlingham Club Ground', 'Buenos Aires'): ('Hurlingham Club Ground', 'Buenos Aires', 'Argentina'),
    ('Independence Park', 'Port Vila'): ('Independence Park', 'Port Vila', 'Vanuatu'),
    ('Jadavpur University Campus 2nd Ground', 'Kolkata'): ('Jadavpur University Campus 2nd Ground', 'Kolkata', 'India'),
    ('John Davies Oval', 'Queenstown'): ('John Davies Oval', 'Queenstown', 'New Zealand'),
    ('Jubilee Park, Ringwood', 'Melbourne'): ('Jubilee Park, Ringwood', 'Melbourne', 'Australia'),
    ('Kensington Oval', 'Bridgetown'): ('Kensington Oval', 'Bridgetown', 'Barbados'),
    ('Kotambi Stadium', 'Vadodara'): ('Kotambi Stadium', 'Vadodara', 'India'),
    ('Latrobe Recreation Ground', 'Latrobe'): ('Latrobe Recreation Ground', 'Latrobe', 'Australia'),
    ('M Chinnaswamy Stadium', 'Bengaluru'): ('M Chinnaswamy Stadium', 'Bengaluru', 'India'),
    ('Maharaja Yadavindra Singh International Cricket Stadium', 'New Chandigarh'): ('Maharaja Yadavindra Singh International Cricket Stadium', 'New Chandigarh', 'India'),
    ('Malahide', 'Dublin'): ('Malahide', 'Dublin', 'Ireland'),
    ('Malek Cricket Ground', 'Ajman'): ('Malek Cricket Ground', 'Ajman', 'United Arab Emirates'),
    ('Maple Leaf North-East Ground', 'King City'): ('Maple Leaf North-East Ground', 'King City', 'Canada'),
    ('Marina Ground', 'Corfu'): ('Marina Ground', 'Corfu', 'Greece'),
    ('Marrara Stadium', 'Darwin'): ('Marrara Stadium', 'Darwin', 'Australia'),
    ('Mission Road Ground', 'Mong Kok'): ('Mission Road Ground', 'Mong Kok', 'Hong Kong'),
    ('Mladost Cricket Ground', 'Zagreb'): ('Mladost Cricket Ground', 'Zagreb', 'Croatia'),
    ('Namibia Cricket Ground', 'Windhoek'): ('Namibia Cricket Ground', 'Windhoek', 'Namibia'),
    ('Nassau County International Cricket Stadium', 'New York'): ('Nassau County International Cricket Stadium', 'New York', 'USA'),
    ('National Cricket Stadium', "St George's"): ('National Cricket Stadium', "St George's", 'Grenada'),
    ('National Sports Academy', 'Sofia'): ('National Sports Academy', 'Sofia', 'Bulgaria'),
    ('New Farnley CC', 'Leeds'): ('New Farnley CC', 'Leeds', 'England'),
    ('Nigeria Cricket Federation Oval 1', 'Abuja'): ('Nigeria Cricket Federation Oval 1', 'Abuja', 'Nigeria'),
    ('Nigeria Cricket Federation Oval 2', 'Abuja'): ('Nigeria Cricket Federation Oval 2', 'Abuja', 'Nigeria'),
    ('North Marine Road Ground', 'Scarborough'): ('North Marine Road Ground', 'Scarborough', 'England'),
    ('Punjab Cricket Association IS Bindra Stadium', 'Mohali'): ('Punjab Cricket Association IS Bindra Stadium', 'Mohali', 'India'),
    ("Queen's Park Oval", 'Port of Spain'): ("Queen's Park Oval", 'Port of Spain', 'Trinidad and Tobago'),
    ('Ray Mitchell Oval, Harrup Park', 'Mackay'): ('Ray Mitchell Oval, Harrup Park', 'Mackay', 'Australia'),
    ('Reforma Athletic Club', 'Naucalpan'): ('Reforma Athletic Club', 'Naucalpan', 'Mexico'),
    ('Royal Brussels Cricket Club Ground', 'Waterloo'): ('Royal Brussels Cricket Club Ground', 'Waterloo', 'Belgium'),
    ('Ruaraka Sports Club Ground', 'Nairobi'): ('Ruaraka Sports Club Ground', 'Nairobi', 'Kenya'),
    ('Sabina Park', 'Kingston'): ('Sabina Park', 'Kingston', 'Jamaica'),
    ('Selangor Turf Club', 'Kuala Lumpur'): ('Selangor Turf Club', 'Kuala Lumpur', 'Malaysia'),
    ('Shrimant Madhavrao Scindia Cricket Stadium', 'Gwalior'): ('Shrimant Madhavrao Scindia Cricket Stadium', 'Gwalior', 'India'),
    ('Sikh Union Club Ground', 'Nairobi'): ('Sikh Union Club Ground', 'Nairobi', 'Kenya'),
    ('Simar Cricket Ground', 'Rome'): ('Simar Cricket Ground', 'Rome', 'Italy'),
    ('Simonds Stadium', 'South Geelong'): ('Simonds Stadium', 'South Geelong', 'Australia'),
    ('Sir Vivian Richards Stadium', 'North Sound'): ('Sir Vivian Richards Stadium', 'North Sound', 'Antigua and Barbuda'),
    ('Sportpark Harga', 'Schiedam'): ('Sportpark Harga', 'Schiedam', 'Netherlands'),
    ('St Albans Club', 'Buenos Aires'): ('St Albans Club', 'Buenos Aires', 'Argentina'),
    ("St George's College Ground", 'Buenos Aires'): ("St George's College Ground", 'Buenos Aires', 'Argentina'),
    ("St George's Park", 'Gqeberha'): ("St George's Park", 'Gqeberha', 'South Africa'),
    ('Stanley Park', 'Blackpool'): ('Stanley Park', 'Blackpool', 'England'),
    ('Stars Arena Hofstade', 'Zemst'): ('Stars Arena Hofstade', 'Zemst', 'Belgium'),
    ('Stubberudmyra Cricket Ground', 'Oslo'): ('Stubberudmyra Cricket Ground', 'Oslo', 'Norway'),
    ('Svanholm Park', 'Brondby'): ('Svanholm Park', 'Brondby', 'Denmark'),
    ('TCA Oval', 'Blantyre'): ('TCA Oval', 'Blantyre', 'Malawi'),
    ('Titwood', 'Glasgow'): ('Titwood', 'Glasgow', 'Scotland'),
    ('Trafalgar Road Ground', 'Southport'): ('Trafalgar Road Ground', 'Southport', 'England'),
    ('University of Tasmania Stadium', 'Launceston'): ('University of Tasmania Stadium', 'Launceston', 'Australia'),
    ('Vassil Levski National Sports Academy', 'Sofia'): ('Vassil Levski National Sports Academy', 'Sofia', 'Bulgaria'),
    ('Velden Cricket Ground', 'Latschach'): ('Velden Cricket Ground', 'Latschach', 'Austria'),
    ('Warner Park', 'Basseterre'): ('Warner Park', 'Basseterre', 'Saint Kitts and Nevis'),
    ('Windsor Park', 'Roseau'): ('Windsor Park', 'Roseau', 'Dominica'),
    ('Woodbridge Road', 'Guildford'): ('Woodbridge Road', 'Guildford', 'England'),
    ('Woodley Cricket Field', 'Los Angeles'): ('Woodley Cricket Field', 'Los Angeles', 'USA'),
    ('YSD-UKM Cricket Oval', 'Bangi'): ('YSD-UKM Cricket Oval', 'Bangi', 'Malaysia'),
