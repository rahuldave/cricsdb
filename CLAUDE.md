...
- Build-ready specs: `internal_docs/spec-inning-split.md`, `internal_docs/spec-filterbar-team-class-v3.md`, `internal_docs/spec-filterbar-team-class-club.md`, `internal_docs/spec-distribution-stats.md`, `internal_docs/spec-splits-mosaic.md`, `internal_docs/splits-mosaic-cross-page.md`, `internal_docs/spec-rate-vs-volume-audit.md`, **`internal_docs/spec-player-baseline-aux-fallback.md` (Phase 1 controls + Phase 2 player toss + Phase 3a inningsbatterperf columns SHIPPED; Phase 3b live cohort fallback PAUSED pending the convention fix below)**, **`internal_docs/spec-batting-allball-runs-single-source.md` (NEXT — fix the all-ball batting-runs convention across the player side + complete `inningsbatterperf` with non-striker innings + re-derive `playerscopestatsposition` as a rollup of it; unblocks 3b. Drafted 2026-05-27)**
